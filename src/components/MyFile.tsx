...
const MyFile = () => {
  return (
    <tr className="text-sm leading-none text-gray-600 h-16 cursor-pointer">
        ...
        <td>
            <button class="bg-grey-light text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center hover:bg-yellow-200 ">
        ...
        <td>
            <button class="bg-grey-light text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center hover:bg-red-500 hover:text-gray-100">
