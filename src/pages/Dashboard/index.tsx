        ...
        <div className="flex flex-col justify-between h-full">
          <div className="flex-grow">
            ...
            <div className="p-4">
              ...
              <li>
                  <Link to="notes" className="flex bg-yellow-200 hover:bg-yellow-50 rounded-xl font-bold text-sm text-yellow-900 py-3 px-4">
                ...
                <li>
                  <Link to="events" className="flex items-center bg-white rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
